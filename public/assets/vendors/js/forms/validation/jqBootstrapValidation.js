    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "Demasiado bajo, el mínimo es '" + min + "'<!-- data-validation-min-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "La dirección de email no es válida<!-- data-validation-email-message to override -->";
                        ...
                        function (e, params) {
                            ...
                            if (errorsFound.length) {
                                ...
                                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                    ...
                                    // $helpBlock.html("<div style=\"width: 100%;margin-top: 5px;\" class=\"tag tag-pill tag-danger\" role=\"alert\"><div>" + errorsFound.join("</li><li>") + "</li></ul>" +
                                        // ( settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : "" ));
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "Esto campo es requerido<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
