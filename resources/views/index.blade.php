            ...
            <div class="container">
                <ul class="info-block info-block--header">
                    <li class="info-block__item info-block__item--contact-secondary">
                        ...
                        <a class="info-block__link" {{-- href="mailto:info@alchemists.com" --}}>soporte@tincazo.com</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container">
                <div class="header__primary-inner">
                    ...
                    <div class="header-logo">
                        <a href="/"><img src="assets/images/soccer/tincaso.png" style="width: 150px; height: 150px"  alt="Alchemists" class="header-logo__img"></a>
                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                              <ul class="posts posts--simple-list">
                                ...
                                <li class="posts__item posts__item--category-1">
                                  ...
                                  <div class="posts__inner">
                                    <div class="posts__cat">
                                      <span style="white-space: pre-wrap; width: 100%"  class="label posts__cat-label"><a href="{{ route('touinf.tournament', $objTorneosUsersMenu->secconnuuid) }}" style="color: white;font-size: 11px;" >{{ $objTorneosUsersMenu->touinftname }}</a></span>
                                    </div>
                                    <h6 class="posts__title"><a href="{{ route('touinf.tournament', $objTorneosUsersMenu->secconnuuid) }}" style="color: white;font-size:9px;">{{ $objTorneosUsersMenu->touinftname }}</a> </h6>
                                  </div>
                        </li>
                        @endforeach
                      </ul>
