        ...
        <input type="hidden" id="fecha-actual-server" value="{{ Carbon\Carbon::now()->toDateString() }}"/>
            <div class="site-wrapper clearfix">
                ...
                @show
                               ...
                               <div class="site-content" id="site-content-intrucciones">
      <div class="container">
...
<p>No te olvides revisar que en las <strong>POSICIONES</strong>, están los puntos que vas acumulando.</p>
...
<!-- Login/Register Tabs Modal -->
 @include('partials.partialModalOfline')
<!-- Javascript Files
  ================================================== -->
<!-- Core JS -->
...
<script src="{{ URL::to('assets/vendors/js/tables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ URL::to('assets/vendors/js/tables/datatable/dataTables.bootstrap4.min.js') }}"></script>
...
<script src="/js/indexOfline.js?v={{ time() }}" type="text/javascript">
</script>
