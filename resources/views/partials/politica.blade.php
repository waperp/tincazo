            ...
            <article class="card card--lg post post--single post--extra-top">
              <div class="card__content" id="instrucciones">
                ...
                <h2>Política de privacidad</h2> <p>
                    ...
                    Los términos utilizados en esta Política de privacidad tienen los mismos significados que en nuestros Términos y condiciones, a los que se puede acceder a menos que se defina lo contrario en esta Política de privacidad.
                  </p> <p><strong>Recopilación y uso de información</strong></p> <p>
                    Para una mejor experiencia, mientras usamos nuestro Servicio, es posible que le solicitemos que nos proporcione cierta información de identificación personal, agregue cualquier otra información que recopile aquí, por ejemplo, nombre de usuario, dirección, fotos La información que solicitamos será retenida por nosotros y utilizada como se describe en esta política de privacidad.
                  </p> <p>
                   La aplicación utiliza servicios de terceros que pueden recopilar información utilizada para identificarlo.
                      ...
                      Enlace a la política de privacidad de los proveedores de servicios de terceros utilizados por la aplicación
                        ...
                        <li><a href="https://onesignal.com/privacy_policy" target="_blank">OneSignal</a></li><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----></ul></div> <p><strong>Dato de registro</strong></p> <p>
                  ...
                  </p> <ul><li>Para facilitar nuestro Servicio</li> <li>TPara proporcionar el Servicio en nuestro nombre</li> <li>Para realizar servicios relacionados con el servicio o</li> <li>TPara ayudarnos a analizar cómo se utiliza nuestro servicio.</li></ul> 
