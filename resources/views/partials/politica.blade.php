          ...
          <div class="content col-md-8 col-md-offset-2">
            ...
            <article class="card card--lg post post--single">
              <div class="card__content">
                ...
                La aplicación TINCAZO es gratuita. Este servicio no tiene costo y está diseñado para ser utilizado de esa manera.
                  </p> <p>
                  Esta página se utiliza para informar a los visitantes sobre nuestras políticas en cuanto a recopilación, uso y divulgación de información personal para cualquierda que decida utilizar nuestro Servicio.</p> 
                    <p>
                  Si elige usar nuestro Servicio, entonces acepta la recopilación y el uso de la información en relación con esta política. La información personal que recopilamos se
utiliza para proporcionar y mejorar el servicio. No utilizaremos ni compartiremos su información con nadie, excepto como se describe en esta Política de Privacidad.
                  </p> <p>
                  Los términos utilizados en esta Política de Privacidad tienen los mismos significados que en nuestros Términos y Condiciones, a los que se puede acceder a menos que se defina lo contrario en esta Política de Privacidad.</p> 
                  <p><strong>Recopilación y uso de información</strong></p> <p>
                  Para una mejor experiencia, mientras usamos nuestro Servicio, es posible que le solicitemos que nos proporcione cierta información de identificación personal, por ejemplo, correo electronco, dirección, fotos, otros. La información que solicitamos será retenida por nosotros y utilizada como se describe en esta Política de Privacidad.</p>
                  <p>
                  La aplicación utiliza servicios de terceros que pueden recopilar información utilizada para identificarlo. Enlace a la Política de Privacidad de los proveedores de servicios de terceros utilizados por la aplicación
                  </p> <div>
                    <p>
                  ...
                  </p> <p><strong>Proveedores de servicio
</strong></p> <p>
Es posible que contratemos a empresas y personas de terceros debido a las siguientes razones:
                  ...
                  <li>Para ayudarnos a analizar cómo se utiliza nuestro Servicio.</li></ul> 
                  <p>Queremos informar a los usuarios de este Servicio que estos terceros tienen acceso a su Información personal. La razón es realizar las tareas asignadas a ellos en nuestro nombre. Sin embargo, están obligados a no divulgar o utilizar la información para ningún otro propósito.
                  ...
                  </p>  <p><strong>Cambios a esta política de privacidad
</strong></p> <p>
                   ...
                   Si tiene alguna pregunta o sugerencia sobre nuestra Política de privacidad, no dude en ponerse en contacto con nosotros en tincazo.info@gmail.com.
